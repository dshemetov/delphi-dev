...
bin.draws.0.5[1:25]
bin.draws.0.5[475:500]
bin.draws.0.5[seq_len(0)]
```
...
a[1] + a[5]
a[2] < a[10]
c(2, 10)[which.max(a[c(2, 10)])]

a[a == 3]
length(a[a == 3])
choose(15, 3) * 0.5^3 * 0.5^(15 - 3) * 500

dbinom(3, 15, 0.5) * 500
all.equal(
  pbinom(3, 15, 0.5),
  dbinom(3, 15, 0.5) + dbinom(2, 15, 0.5) + dbinom(1, 15, 0.5) + dbinom(0, 15, 0.5)
)
```
...
args <- list(data.frame(a = 1, b = 2), NULL, data.frame(a = 1, b = 2))
rbind(!!!args)
rlang::inject(rbind(!!!args))
...
```{r q3a}
a2 <- rbinom(n = 500, size = 15, prob = 0.2)
a3 <- rbinom(n = 500, size = 15, prob = 0.3)
a4 <- rbinom(n = 500, size = 15, prob = 0.4)
a6 <- rbinom(n = 500, size = 15, prob = 0.6)
a7 <- rbinom(n = 500, size = 15, prob = 0.7)
a8 <- rbinom(n = 500, size = 15, prob = 0.8)
```
...
```{r q4a}
bin.matrix <- matrix(rbinom(n = 500 * 7, size = 15, prob = c(0.2, 0.3, 0.4, 0.6, 0.7, 0.8)), nrow = 500, ncol = 7)
bin.matrix <- array(c(a2, a3, a4, a6, a7, a8), dim = c(500, 6))
bin.matrix <- cbind(a2, a3, a4, a6, a7, a8)
bin.matrix
...
vctrs::vec_c(list(1, 2), list(3, 4))
vctrs::vec_c(c(1, 2), c(3, 4))
```
